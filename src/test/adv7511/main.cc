...
struct Test::Main {
	...
	I2c_driver driver = { env, Board_base::I2C0_MMIO_BASE, Board_base::I2C_MMIO_SIZE };
	Adv7511 adv7511 = { Config::ADV7511_ADDR_1, driver };
	
	Axi_hdmi   axi_hdmi   = { env, 0x6c000000, 0x10000};  /* FIXME: add to board_base.h */
	Axi_clkgen axi_clkgen = { env, 0x66000000, 0x10000};  /* FIXME: add to board_base.h */
...
void Test::Main::dump(Adv7511 &adv7511)
{
	uint8_t value; 
